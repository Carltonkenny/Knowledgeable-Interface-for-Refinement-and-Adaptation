...
export const metadata = {
  ...
  description: 'Insights on prompt engineering, AI workflows, and building PromptForge. Coming soon.',
}
        ...
        <div className="max-w-lg w-full text-center">
          <div className="glass-card p-10 md:p-14">
            ...
            <p className="text-[14px] text-text-dim leading-relaxed mb-8">
              We&apos;re working on sharing our thoughts on prompt engineering, AI workflows, 
              and what we&apos;re learning while building PromptForge. Stay tuned.
            </p>
            <a
              href="/"
