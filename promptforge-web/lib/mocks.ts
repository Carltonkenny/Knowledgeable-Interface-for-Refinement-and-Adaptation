...
export const MOCK_HISTORY: HistoryItem[] = [
  {
    ...
    domain_analysis: { primary_domain: 'strategic business', sub_domain: 'client communications' },
    domain: 'strategic business',
    sub_domain: 'client communications',
    created_at: new Date().toISOString(),
    session_id: 'mock-session-1',
  },
  {
    id: 'mock-hist-2',
    raw_prompt: 'write a linkedin post about saas',
    ...
    domain_analysis: { primary_domain: 'creative synthesis', sub_domain: 'content strategy' },
    domain: 'creative synthesis',
    sub_domain: 'content strategy',
